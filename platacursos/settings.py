...
ALLOWED_HOSTS = ['*']  # MUST be configured in production to prevent HTTP Host header attacks
...
# Permite upload de arquivos de até 1 GB (em bytes)
FILE_UPLOAD_MAX_MEMORY_SIZE = 1073741824
DATA_UPLOAD_MAX_MEMORY_SIZE = 1073741824

# Backend de autenticação customizado para E-mail
